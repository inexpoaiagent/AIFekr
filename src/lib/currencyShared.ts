// Pure currency data/logic with no DOM access — safe to import from both
// server (API routes) and client code. Split out from currency.ts because
// that file has "use client" (needed for its cookie helpers), which made
// its exports come back as undefined when imported from a server route.
